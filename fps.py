...
def serial_ports():
    ...
    if os.name == 'nt':
        ...
        # unix
        _serial_ports = ["/dev/ttyO2","/dev/ttyAMA0"]
...
if os.name == 'nt':
    ...
    DEVICE_NAME = "/dev/ttyAMA0"  #default device to use (Place correct BBb UART port here)
...
class FPS_GT511C3(object,SerialCommander):
    _serial = None
    _lastResponse = None
